...
normalized as (
    select
        ...
        trim(lane) as lane,
        try_cast(quote_date as timestamp) as quote_at,
        try_cast(book_date as timestamp) as booked_at,
        try_cast(source_date as timestamp) as sourced_at,
        try_cast(pickup_date as timestamp) as pickup_at,
        try_cast(delivery_date as timestamp) as delivered_at,
        ...
        try_cast(pickup_appointment_time as timestamp) as pickup_appointment_at,
        try_cast(delivery_appointment_time as timestamp) as delivery_appointment_at,
